...
def generate_launch_description():
    ...
    # Files
    map_params = PathJoinSubstitution(
    ...
    remappings = [('/helmoro_localization/scan', '/sensors/lidar/scan'),('/helmoro_localization/tf', 'tf'), ('/helmoro_localization/tf_static', 'tf_static')]
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value=map_params, description='Full path to map yaml file to load'
    )
    ...
    load_nodes = GroupAction(
        actions=[
            PushRosNamespace('helmoro_localization'),
