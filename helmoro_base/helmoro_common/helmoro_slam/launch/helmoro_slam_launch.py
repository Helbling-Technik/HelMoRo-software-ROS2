...
def generate_launch_description():
    ...
    helmoro_slam_pkg = get_package_share_directory('helmoro_slam')
    slam_toolbox_dir = get_package_share_directory('slam_toolbox')

    # Files
    nav2_params = PathJoinSubstitution(
        [helmoro_slam_pkg, 'config', 'slam_params.yaml'])
    ...
    start_slam_toolbox_cmd = GroupAction(
        ...
        actions=[
            ...
            # SetRemap(src='/sensors/lidar/scan', dst='scan'),
            # SetRemap(src='/helmoro_slam/tf', dst='tf'),
            # SetRemap(src='/helmoro_slam/tf_static', dst='tf_static'),
            # SetRemap(src='/helmoro_slam/map', dst='map'),
