...
def generate_launch_description():
    ...
    # Directories
    helmoro_state_estimation_pkg = get_package_share_directory(
        "helmoro_state_estimation"
    )

    # Files
    state_estimation_params = PathJoinSubstitution(
        [helmoro_state_estimation_pkg, "config", "ekf_params.yaml"]
    )
    ...
    load_nodes = GroupAction(
        actions=[
            ...
            Node(
                ...
                remappings=[
                    ("/helmoro_state_estimation/tf", "tf"),
