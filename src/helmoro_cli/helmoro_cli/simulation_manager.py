...
class SimulationManager:
    ...
    def spawn_robot(self, name, x, y, z, yaw):
        ...
        spawn = f"sudo NAMESPACE={name} X={x} Y={y} Z={z} YAW={yaw} \
            docker compose -p sim_{name} -f /home/ws/.devcontainer/docker-compose.yml up spawn_robot"

        ros_gz_bridge = f"sudo NAMESPACE={name} WORLD={self.world} \
            docker compose -p robot_{name} -f /home/ws/.devcontainer/docker-compose.yml up gz_ros_bridge --detach --wait"
    ...
    def delete_robot(self, name):
        ...
        os.system(
            ...
            docker compose -p sim_{name} -f /home/ws/.devcontainer/docker-compose.yml up despawn_robot --detach --wait"
        )
    ...
    def start_simulation(self, world):
        ...
        simulation = f"sudo docker compose -f /home/ws/.devcontainer/docker-compose.yml up simulation --detach --wait"
    ...
    def stop_simulation(self):
        ...
        stop_simulation = f"sudo docker compose -f /home/ws/.devcontainer/docker-compose.yml down simulation --timeout 1"
